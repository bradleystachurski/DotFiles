local timer_begin_sound = hs.sound.getByFile("private/sounds/clock-winding-1.mp3")
local timer_end_sound = hs.sound.getByFile("private/sounds/bell_ting_ting.mp3")
